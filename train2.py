...
out_dir = os.path.join(out_dir, time_str)
if master_process:
...
if init_from == 'scratch':
    ...
    print(f"Resuming training from {resume_out_dir}")
    # resume training from a checkpoint.
    ckpt_path = os.path.join(resume_out_dir, 'ckpt.pt')
...
if wandb_log and master_process:
    import wandb
    wandb_run_name = f"new_{wandb_run_name}_{time_str}"
